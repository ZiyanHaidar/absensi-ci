                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div class="col-md-3 mb-4">
                            <div
                                class="card shadow bg-D8D9DA text-black shadow border-15 rounded ustify-content-between align-items-center">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <h1>Absensi Karyawan</h1>

                                    <button onclick="absen()" class="btn btn-primary">Absen</button>
